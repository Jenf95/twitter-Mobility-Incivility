...
uncivil_words <- readChar("C:/Users/Jenny/Desktop/BU COM/Fall 2019/EM 855 Comp Assisted Text Analysis/Research Project/Data/cursing_lexicon_in_one_line.txt", nchars = 1e6)
